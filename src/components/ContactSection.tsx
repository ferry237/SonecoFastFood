...
const ContactCompoment = () => {
  return (
    <section id="Contact" className="lg:px-[6rem] px-[1.5rem] w-full flex flex-col lg:py-[4rem] py-[3rem] gap-[3rem] justify-center items-center lg:gap-[3rem] border-t-solid border-t-[0.1rem] border-t-[var(--color-accent)]">
        ...
        <p className="lg:text-[2rem] text-[1.7rem] text-[var(--color-secondary)] font-[Montserrat] text-center lg:px-[20rem] px-[1.7rem]">Pour toute réservation ou demande d&apos;information, n&apos;hésitez pas à nous contacter via les numéros suivants:</p>
